...
def shared_pods
    ...
    pod 'KeanuCore', :git => 'https://gitlab.com/keanuapp/keanuapp-ios.git', :commit => 'c97ac29bb'
...
target 'Zom 2' do
  ...
  pod 'Keanu', :git => 'https://gitlab.com/keanuapp/keanuapp-ios.git', :commit => 'c97ac29bb'
end
...
target 'ShareExtension' do
  ...
  pod 'KeanuExtension', :git => 'https://gitlab.com/keanuapp/keanuapp-ios.git', :commit => 'c97ac29bb'
end
