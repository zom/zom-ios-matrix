...
def shared_pods
    ...
    pod 'KeanuCore', :git => 'https://gitlab.com/keanuapp/keanuapp-ios.git', :commit => '147cfb34'
...
target 'Zom 2' do
  ...
  pod 'Keanu', :git => 'https://gitlab.com/keanuapp/keanuapp-ios.git', :commit => '147cfb34'
end
...
target 'ShareExtension' do
  ...
  pod 'KeanuExtension', :git => 'https://gitlab.com/keanuapp/keanuapp-ios.git', :commit => '147cfb34'
end
